...
export default function Nav(props: NavProps<ReturnedNavDataProps[]>) {
  ...
  const onScrollStyles =
    "sticky z-20 top-0 left-0 bg-light-background dark:bg-dark-background w-full border-b border-light-accent dark:border-dark-accent transition-all duration-75 ease-in m-auto rounded-none";
    ...
    <>
      <Navbar
        ...
        className={
          scrolled
            ? onScrollStyles
            : "z-20 bg-light-background dark:bg-dark-background w-full border-b border-light-accent dark:border-dark-accent m-auto"
        }
      >
