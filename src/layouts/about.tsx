...
export default function About() {
  ...
  return (
    <section className="grid gap-12 justify-center pt-4 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-w-screen-xl m-4 lg:m-auto lg:pt-16 px-4 pb-28 xl:pb-0">
